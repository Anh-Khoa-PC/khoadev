      ...
      <div className="max-w-7xl mx-auto px-4 md:px-12 flex flex-col lg:flex-row gap-16 items-center">
        ...
        <div className="lg:w-1/2 relative z-10">
            ...
            <p className="text-neutral-400 text-lg leading-relaxed mb-6 max-w-xl">
                Cybersecurity is not just about code—it's a responsibility. Recognized by <strong className="text-white">PA05 HCMC</strong> and the <strong className="text-white">Anti-Scam</strong> team, I use technology to protect the community and secure the future of our digital space.
            </p>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-12">
                <div className="bg-neutral-900/50 border border-neutral-800 p-6 rounded-lg hover:border-blue-500/50 transition-colors group">
                    <div className="flex items-center justify-between mb-4">
                        <Shield className="w-8 h-8 text-blue-500" />
                        <span className="text-[10px] font-mono text-neutral-500">OFFICIAL</span>
                    </div>
                    <h4 className="font-bold text-white text-xl">PA05 TP.HCM</h4>
                    <p className="text-sm text-neutral-400 mt-2 leading-relaxed">
                        Recognized by the Department of Cyber Security for contributions to protecting the digital space.
                    </p>
                </div>
                <div className="bg-neutral-900/50 border border-neutral-800 p-6 rounded-lg hover:border-green-500/50 transition-colors group">
                    <div className="flex items-center justify-between mb-4">
                        <Shield className="w-8 h-8 text-green-500" />
                        <span className="text-[10px] font-mono text-neutral-500">COMMUNITY</span>
                    </div>
                    <h4 className="font-bold text-white text-xl">Anti-Scam</h4>
                    <p className="text-sm text-neutral-400 mt-2 leading-relaxed">
                        Acknowledged by Hieu PC for efforts in Scam Fighting and protecting the Vietnamese community.
                    </p>
                </div>
            </div>
        </div>
