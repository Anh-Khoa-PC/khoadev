      ...
      <div className="relative z-10 flex-grow flex flex-col justify-center">
         <div className="relative select-none">
            ...
            <motion.div 
               ...
               className="absolute right-4 top-1/2 -translate-y-1/2 md:right-[15%] md:top-[60%] w-24 h-24 md:w-36 md:h-36 bg-white rounded-full flex flex-col items-center justify-center text-black z-30 shadow-[0_0_40px_rgba(255,255,255,0.3)] cursor-pointer p-4 text-center"
            >
               <span className="text-[10px] font-mono uppercase mb-1">CODING SINCE</span>
               <span className="font-black text-lg md:text-2xl leading-none">GRADE 2</span>
            </motion.div>
         </div>
      </div>
      ...
      <div className="relative z-10 flex flex-col md:flex-row justify-between items-end gap-8 pb-4">
         ...
         >
           ...
           <p className="text-lg md:text-2xl font-light text-neutral-300 leading-snug">
             Founder of <span className="text-white font-semibold">CR Startup</span>. Recognized by <span className="text-white font-semibold">PA05 HCMC</span> & <span className="text-white font-semibold">Hieu PC</span>.
             <br/><span className="text-neutral-500 italic">"Using technology to protect the community."</span>
           </p>
         </motion.div>
