...
const timelineData = [
  { year: "GRADE 2", title: "THE SPARK", description: "Wrote my very first lines of code. While others were playing games, I was figuring out how they were built." },
  { year: "AGE 13", title: "DEEP DIVE", description: "Specialized in Cybersecurity. Transitioned from general coding to offensive and defensive security research." },
  { year: "2023", title: "CR STARTUP", description: "Founded CR Startup. A collective focused on engineering digital revolutions through robust architecture." },
  { year: "2024", title: "SECURITY ELITE", description: "Joined Nexus VN. Pentesting enterprise systems and protecting the digital frontier." },
  { year: "NOW", title: "OFFICIAL RECOGNITION", description: "Recognized by PA05 HCMC and Chống Lừa Đảo (Hiếu PC) for contributions to a safer Vietnamese cyberspace. Milestone reached before age 15." },
];
