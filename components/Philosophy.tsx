...
const principles = [
  ...
  },
  {
    ...
    subtitle: "PROTECTING THE COMMUNITY",
    desc: "Technology is a tool for good. My mission is to secure the digital future for the Vietnamese community."
  },
  {
    id: "III",
    title: "RELENTLESS",
    subtitle: "HUSTLE FOR SAFETY",
    desc: "From Grade 2 to recognized Cybersecurity Researcher. The journey of specialized safety never ends."
  }
];
