    ...
    >
      ...
      <div className="relative h-full bg-neutral-950 border border-neutral-800 group-hover:border-green-500/50 p-8 rounded-lg overflow-hidden flex flex-col justify-between min-h-[500px] transition-colors duration-300">
        ...
        <div className="mt-8 bg-black/50 p-4 rounded border border-green-500/20 font-mono text-[10px] text-green-400/80">
           ...
           <p className="text-white">&gt; PA05: RECOGNITION GRANTED</p>
           <p className="text-white">&gt; ANTI-SCAM: BADGE AWARDED</p>
           {isHovered && (
             <motion.p 
               initial={{ opacity: 0 }} 
    ...
    >
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-12 pt-32 pb-24">
            ...
            <section className="mb-32">
                <h3 className="text-4xl font-bold mb-12 italic tracking-tighter">Proprietary <span className="text-white text-transparent" style={{ WebkitTextStroke: '1px white' }}>Infrastructure.</span></h3>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
                    {/* VANTAGE V-AI */}
                    <div className="p-8 border border-green-500/20 bg-green-500/5 backdrop-blur-sm rounded-xl relative overflow-hidden group hover:border-green-500/50 transition-all duration-500">
                        <div className="absolute top-0 right-0 p-4 font-mono text-[10px] text-green-500 opacity-50 italic uppercase tracking-widest">Core Engine</div>
                        <h4 className="text-2xl font-bold text-white mb-4">VANTAGE V-AI</h4>
                        <p className="text-neutral-400 text-xs leading-relaxed mb-6">
                            Next-gen graph engine processing 10^12 nodes with 0MB RAM footprint. Stateless retrieval scanning 10M+ tokens in {"<"} 0.15s. High-speed cryptographic hashing for zero-lookup discovery.
                        </p>
                        <div className="space-y-2 mb-8">
                           <div className="flex justify-between text-[10px] font-mono border-b border-white/5 pb-1">
                               ...
                               <span className="text-green-500">82M+ TOKENS/S</span>
                           </div>
                           <div className="flex justify-between text-[10px] font-mono border-b border-white/5 pb-1">
                        ...
                        <a 
                            href="https://github.com/Anh-Khoa-PC/VANTAGE-V-AI" 
                            target="_blank" 
                            rel="noopener noreferrer"
                            className="inline-block px-4 py-2 bg-green-500 text-black font-bold text-[10px] uppercase tracking-widest hover:bg-white transition-all rounded-sm"
                        >
                            SOURCE_CODE
                        </a>
                    </div>
                    ...
                    {/* XRGO SECURITIES */}
                    <div className="p-8 border border-red-500/20 bg-red-500/5 backdrop-blur-sm rounded-xl relative overflow-hidden group hover:border-red-500/50 transition-all duration-500">
                        <div className="absolute top-0 right-0 p-4 font-mono text-[10px] text-red-500 opacity-50 italic uppercase tracking-widest">Security</div>
                        <h4 className="text-2xl font-bold text-white mb-4">XRGO</h4>
                        <p className="text-neutral-400 text-xs leading-relaxed mb-6">
                            Enterprise-level digital defense. Leading a global team to block billions of DDoS attempts and expose vulnerabilities for high-stakes enterprise systems.
                        </p>
                        <div className="space-y-2 mb-8">
                           <div className="flex justify-between text-[10px] font-mono border-b border-white/5 pb-1">
                               <span className="text-neutral-500">BLOCK SCALE</span>
                               <span className="text-red-500">5B+ ATTEMPTS</span>
                           </div>
                           <div className="flex justify-between text-[10px] font-mono border-b border-white/5 pb-1">
                               <span className="text-neutral-500">VULNS FOUND</span>
                               <span className="text-red-500">100+</span>
                           </div>
                        </div>
                        <a 
                            href="https://xrgosecurities.com/" 
                            target="_blank" 
                            rel="noopener noreferrer"
                            className="inline-block px-4 py-2 bg-red-500 text-white font-bold text-[10px] uppercase tracking-widest hover:bg-white hover:text-black transition-all rounded-sm"
                        >
                            VISIT SITE
                        </a>
                    </div>
                    ...
                    {/* CR STARTUP */}
                    <div className="p-8 border border-neutral-800 bg-neutral-900/10 backdrop-blur-sm rounded-xl relative overflow-hidden group hover:border-white transition-all duration-500">
                        <div className="absolute top-0 right-0 p-4 font-mono text-[10px] text-neutral-500 opacity-50 italic uppercase tracking-widest">Incubator</div>
                        <h4 className="text-2xl font-bold text-white mb-4">CR STARTUP</h4>
                        <p className="text-neutral-400 text-xs leading-relaxed mb-6">
                            The technological breakthrough engine. Architecting digital manifestos and ecosystems that redefine human empowerment through invisible tech.
                        </p>
                        <div className="pt-4 border-t border-white/5">
                            <a 
                                href="http://crvn.netlify.app/" 
                                target="_blank" 
                                rel="noopener noreferrer"
                                className="text-[10px] text-white hover:underline tracking-widest font-mono uppercase"
                            >
                                Explore Ecosystem →
                            </a>
                        </div>
            ...
            <div className="mt-32 pt-12 border-t border-neutral-900 flex flex-col md:flex-row justify-between items-start gap-12">
                ...
                <div className="flex flex-wrap justify-center gap-4 mt-8">
                    {[
                        { name: "LinkedIn", href: "https://www.linkedin.com/in/nguy%E1%BB%85n-v%C3%B5-anh-khoa-khoa-dev-a893b1306" },
                        ...
                        <a 
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="text-neutral-500 text-sm hover:text-white cursor-pointer transition-colors px-4 py-2 border border-neutral-800 rounded-full hover:border-white"
                        >
                            {social.name}
                        </a>
                    ))}
        ...
        >
            ...
            <div className="max-w-5xl mx-auto px-4 md:px-12 pt-32 pb-24 relative z-10">
                ...
                <section className="mb-20">
                    ...
                    >
                        <h1 className="text-3xl md:text-5xl font-bold mb-4 text-white">
                            Hello, I am <br/>
                            <span className="text-green-500 text-6xl">Khoa Dev</span> 👋
                        </h1>
                        <p className="text-lg text-green-500/80 max-w-2xl leading-relaxed italic mb-4">
                            "A continuation from those who came before. Using technology to protect the community."
                        </p>
                        <p className="text-lg text-green-500/80 max-w-2xl leading-relaxed">
                            A cybersecurity researcher from Ho Chi Minh City. Recognizing that security is a responsibility, I've dedicated my journey since Grade 2 to securing the digital landscape of Vietnam.
                        </p>
                    </motion.div>
                </section>
                ...
                <section className="mb-20">
                    ...
                    <p className="mb-6 text-sm text-green-500/60">I have been officially recognized for security contributions to the community:</p>
                    
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        {['PA05 HCMC', 'Hieu PC', 'Anti-Scam', 'Nexus VN'].map((org, i) => (
                            <motion.div 
                                key={org}
                                initial={{ opacity: 0, scale: 0.9 }}
                                whileInView={{ opacity: 1, scale: 1 }}
                                transition={{ delay: i * 0.1 }}
                                className="h-24 flex items-center justify-center bg-black border border-green-500/20 rounded hover:border-green-500 hover:bg-green-500/10 transition-all cursor-crosshair group px-4 text-center"
                            >
                                <span className="font-bold text-sm md:text-lg group-hover:text-white transition-colors">{org}</span>
                            </motion.div>
                        ))}
                    </div>
                </section>
                ...
                <section>
                    ...
                    <div className="flex flex-wrap gap-4">
                        {[
                            { name: 'LinkedIn', href: 'https://www.linkedin.com/in/nguy%E1%BB%85n-v%C3%B5-anh-khoa-khoa-dev-a893b1306' },
                            { name: 'Facebook', href: 'https://www.facebook.com/anhkhoavnk/' },
                            { name: 'GitHub', href: 'https://www.facebook.com/anhkhoavnk/' }
                        ].map(social => (
                            <a 
                                key={social.name} 
                                href={social.href}
                                target="_blank"
                                rel="noopener noreferrer"
                                className="px-6 py-3 border border-green-500 text-green-500 font-bold uppercase hover:bg-green-500 hover:text-black transition-all"
                            >
                                {social.name}
                            </a>
                        ))}
